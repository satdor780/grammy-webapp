    ...
    >
      ...
      <div className="flex min-h-10 w-full flex-wrap items-center gap-1.5 rounded-md border border-input bg-background px-3 py-2 text-sm focus-within:ring-1 focus-within:ring-zinc-500 disabled:cursor-not-allowed disabled:opacity-50 dark:focus-within:ring-zinc-400">
        ...
        <TagsInput.TagsInputInput
          ...
          className="flex-1 min-w-[80px] bg-transparent outline-hidden placeholder:text-zinc-500 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-zinc-400"
        />
        <button
          type="button"
          tabIndex={0}
          onClick={(e) => (e.currentTarget as HTMLButtonElement).focus()}
          className="shrink-0 rounded-md border border-input bg-transparent p-2 text-zinc-600 shadow-xs transition-colors hover:bg-zinc-100 hover:text-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-500 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 dark:focus:ring-zinc-400"
          title="Add tag"
          aria-label="Add tag"
        >
